...
btnDifficulte[0].addEventListener("click", () => {
    ...
    opponentSprite.innerHTML = "<img class='large_100' src='https://PainNagato42.github.io/Portfolio/assets/img/img_battlecard_of_zelda/chuchu.png' alt=''>";
    spanLevel[1].textContent = "Chuchu bleu";
})
btnDifficulte[1].addEventListener("click", () => {
    choixDifficulte.style.display = "none";
    difficulty = 2;
    opponentSprite.innerHTML = "<img class='large_100' src='https://PainNagato42.github.io/Portfolio/assets/img/img_battlecard_of_zelda/chuchu_feu.png' alt=''>";
    spanLevel[1].textContent = "Chuchu de feu";
})
btnDifficulte[2].addEventListener("click", () => {
    choixDifficulte.style.display = "none";
    difficulty = 3;
    opponentSprite.innerHTML = "<img class='large_100' src='https://PainNagato42.github.io/Portfolio/assets/img/img_battlecard_of_zelda/chuchu_electrique.png' alt=''>";
...
function opponent() {
    if (difficulty === 1) {
        ...
        for (let i = 0; i < tabNameImg.length; i++) {
            switch (lvl) {
                case i + 2:
                    opponentSprite.innerHTML = "<img class='large_100' src='https://PainNagato42.github.io/Portfolio/assets/img/img_battlecard_of_zelda/" + tabNameImg[i] + ".png' alt=''>"
